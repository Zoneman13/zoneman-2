...
module.exports = Ramdani = async (Ramdani, Ramdanif) => {
  try {
    ...
    const fkontak = { key: { participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: `6283136505591-1614953337@g.us` } : {}) }, message: { 'contactMessage': { 'displayName': `@Zoneman`, 'vcard': `BEGIN:VCARD\nVERSION:3.0\nN:XL;@Zoneman,;;;\nFN:@Zoneman,\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, 'jpegThumbnail': fs.readFileSync(`./foto/Ramdani.jpg`), thumbnail: fs.readFileSync(`./foto/Ramdani.jpg`), senRamdanifhemeral: true } } }
    var fakeReplyList = ['ftroli', 'fdoc', 'fvn', 'fgif', 'fgclink', 'fvideo', 'floc', 'fkontak']
    const replylinkig = (teks) => {
      Ramdani.sendMessage(from, teks, text, { sendEphemeral: true, quoted: ftroli, contextInfo: { forwardingScore: 508, isForwarded: true, externalAdReply: { title: `Hiii ${pushname}`, body: "", mediaType: "2", thumbnail: thumbnail, mediaUrl: `https://www.instagram.com/hyzoneman` } } })
    }
    const fakeitem = (teks) => {
...
break
      ...
      case 'ownermenu':
        ...
        case 'igowner':
        reply(`*https://www.instagram.com/hyzoneman*`)
        break
        case 'totalfitur':
        case 'total fitur':
